        ...
        <SafeAreaView style={[SettingsStyle(theme).Maincontainer, { alignItems: 'center' }]}>
            ...
            <View style={{ flexDirection: 'row', paddingHorizontal: 20, paddingVertical: 10, height: 50 }}>
                ...
                <View style={{ flexDirection: 'column', justifyContent: 'center', flex: 1 }}>
                    ...
                    <Text style={{ color: theme.textColor, fontFamily: Constants.fontFamilyBold, fontSize: 22, textAlign: 'center' }}>Creater Awards</Text>
            ...
            {/* <Text style={[SettingsStyle(theme).SubTitleStyle, { marginLeft: 10, fontSize: 18, fontFamily: Constants.fontFamilyBold }]}></Text> */}

            <ScrollView style={{ marginVertical: 10 }}>
                <View style={{ marginLeft: 25, flex: 1 }}>
                    <Text style={{ marginLeft: 25, fontSize: 18, marginTop: 20, fontFamily: Constants.fontFamilyBold }}>Get Your Awards </Text>
                    <Image source={require('../../Images/ic_awards.png')} resizeMode='stretch' style={{ alignSelf: 'center', marginTop: 20, height: 150, width: 325 }} />
                    ...
                    <Text style={[SettingsStyle(theme).SubTitleStyle, { marginRight: 10, marginTop: 20 }]}>Eligibility check based on your video content and your acting skill. After you appling for participant we check your video content and your acting skill.</Text>
                </View>
            </ScrollView>
