...
export default class CreateNFTScreen extends Component {
    constructor(props) {
            ...
            <SafeAreaView style={{ flex: 1, backgroundColor: Color.primary }}>
                ...
                <ScrollView style={{ flex: 1 }}>
                    <View style={{ padding: 20, flex: 1 }}>
                        ...
                        <FieldComonent exterViewStyle={{ marginTop: 30 }} value={this.state.email} title={'NFT Name'}
                            onChangeText={(text) => {
                        ...
                        <FieldComonent exterViewStyle={{ marginTop: 10 }} value={this.state.email} title={'Description'}
                            onChangeText={(text) => {
                                this.setState({ email: text })
                            }}>
                            <Image source={require('../../Images/email_icon.png')} resizeMode={"contain"}
                        ...
                        <FieldComonent exterViewStyle={{ marginTop: 10 }} value={this.state.email} title={'Price'}
                            onChangeText={(text) => {
                                this.setState({ email: text })
                            }}>
                            <Image source={require('../../Images/email_icon.png')} resizeMode={"contain"}
                        ...
                        <FieldComonent exterViewStyle={{ marginTop: 10 }} value={this.state.email}
                            title={'Select Collection'} onChangeText={(text) => {
                                this.setState({ email: text })
                            }}>
                            <Image source={require('../../Images/email_icon.png')} resizeMode={"contain"}
                                style={{ width: 25, aspectRatio: 1, height: undefined, tintColor: 'black' }} />
                ...
                <View style={{ alignItems: 'center', marginVertical: 20 }}>
                    ...
                    <Button1Component onPress={() => {
                        this.props.navigation.pop()
                    }} extraviewstyle={{ width: '90%' }} title={'Create NFT'} />
                </View>
            </SafeAreaView>
        );
    }
